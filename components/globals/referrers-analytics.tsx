...
export default function ReferrersAnalytics({
  ...
  return (
    <section>
      <div className="relative flex h-[365px] flex-col justify-between overflow-hidden rounded-lg border border-neutral-800 bg-black">
        <div>
              ...
              <DropdownMenu>
                ...
                >
                  <DropdownMenuItem asChild>
                    <button
                      onClick={() =>
                        exportToCSV(referrers, `referrers-analytics`)
                      }
                      className="w-full"
                    >
