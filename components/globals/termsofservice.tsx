...
import { PageHeader, PageHeaderHeading, PageHeaderDescription } from '@/components/globals/pageheader';
import { Card, CardContent } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import Navbar from '../landingpage/navbar-shrink';
import Footer from '../landingpage/footer2';

const TermsOfServicePage = () => {
  return (
    <>
      <Navbar />
      <div className="container max-w-[88rem] mx-auto pt-12 p-6">
        <PageHeader>
          <PageHeaderHeading className='bg-black dark:bg-[radial-gradient(61.17%_178.53%_at_38.83%_-13.54%,#3B3B3B_0%,#888787_12.61%,#FFFFFF_50%,#888787_80%,#3B3B3B_100%)] bg-clip-text text-transparent py-2 pr-2'>Terms of Service</PageHeaderHeading>
